...
const checks = [
    {
        ...
        terms: [
            ...
            'exportSQLiteConnectorCSV',
            'exportSQLiteConnectorMarkdown',
    ...
    {
        file: 'src/features/shell/AccessPolicyCard.tsx',
        terms: ['AccessPolicyCard', 'Access & Approvals', 'Full project access', 'Full read access', 'Reset to guarded'],
    },
    {
        file: 'src/features/shell/AgentChatCard.tsx',
        terms: ['AgentChatCard', 'approveFileWrites', 'composer-write-toggle', 'Writes', 'Submit mode', 'Run agent'],
    },
    {
    ...
    {
        file: '../internal/artifactsvc/service.go',
        terms: ['package artifactsvc', 'type Service struct', 'func New', 'CreateMarkdownReport', 'CreateScanReport', 'CreateGeneratedMarkdown', 'Archive', 'Delete', 'Compare'],
    },
    {
        file: '../dataset_service.go',
        terms: ['DatasetService', 'NewDatasetService', 'Profile', 'QuerySQL', 'SaveSQLQuery', 'SaveSQLiteConnectorQuery', 'ListSQLiteConnectorQueries', 'QueryWorkspaceSQLite', 'CancelWorkspaceSQLiteQuery', 'InspectWorkspaceSQLite', 'CreateSQLiteQueryCSVArtifact', 'CreateSQLiteQueryMarkdownArtifact', 'CreateSQLArtifact', 'CreateSummaryArtifact', 'RebuildDependency'],
    },
    {
    ...
    {
        file: '../app_git.go',
        terms: ['GitStatus', 'GitFileChange', 'GitFileDiff', 'GitFileActionRequest', 'GitFileActionPreview', 'GitHunkActionRequest', 'GitHunkActionPreview', 'GetGitStatus', 'GetGitFileDiff', 'PreviewGitFileAction', 'ApplyGitFileAction', 'PreviewGitHunkAction', 'ApplyGitHunkAction', 'gitservice.New'],
    },
    {
        file: '../internal/gitservice/service.go',
        terms: ['package gitservice', 'type Service struct', 'Status', 'FileDiff', 'PreviewFileAction', 'ApplyFileAction', 'PreviewHunkAction', 'ApplyHunkAction', 'gitHunkActionCommand', 'gitHunkActionStage', 'gitHunkActionUnstage', 'extractGitHunkPatch', 'gitFileActionCommand', 'gitFileDiff', 'cleanGitRelPath', 'parseStatus', 'gitDiffMaxBytes'],
    },
    {
    ...
    },
    {
        ...
        terms: ['Nexus visual gallery', '00-contact-sheet.png', '01-workbench-compact-rail', '04-approval-modal', '08-agent-write-toggle', '17-settings-access', '18-command-palette', '22-mobile-settings'],
    },
    {
        file: 'scripts/visual-fixtures.mjs',
        terms: ['installNexusMocks', 'ListDatasetDependencies', 'ListDatasetSQLRuns', 'ListSQLiteConnectorQueries', 'SaveSQLiteConnectorQuery', 'CreateSQLiteQueryCSVArtifact', 'CreateSQLiteQueryMarkdownArtifact', 'ListWorkspaceProblems', 'ListWorkspaceTasks', 'ListConnectorProfiles', 'SaveConnectorProfile', 'DeleteConnectorProfile', 'SearchMetadata', 'QueryWorkspaceSQLite', 'CancelWorkspaceSQLiteQuery', 'ExportArtifactLineageJSON', 'ImportArtifactLineageJSON', 'dependencies'],
    },
    {
