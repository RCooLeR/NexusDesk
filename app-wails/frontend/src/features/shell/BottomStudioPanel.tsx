...
type SettingsSurface = 'provider' | 'connectors' | 'access';
...
type BottomStudioPanelProps = {
    ...
    onAccessPolicyChange: (field: keyof AccessPolicy, value: AccessPolicy[keyof AccessPolicy]) => void;
    ...
    onQueryDataset: () => void;
    onQueryDatasetSQL: (sql?: string) => void;
            ...
            <div className="bottom-tab-content">
                ...
                {activeTab === 'settings' && (
                    <div className="settings-page">
                        ...
                        {activeSettingsSurface === 'access' && (
                            <AccessPolicyCard
                                policy={accessPolicy}
                                status={accessPolicyStatus}
                                workspace={workspace}
                                onChange={onAccessPolicyChange}
                                onReset={onResetAccessPolicy}
                            />
                        )}
                    </div>
                )}
