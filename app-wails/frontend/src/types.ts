...
export type AccessPolicyMode = 'approval' | 'full';

export type ShellAccessPolicy = 'disabled' | 'approval';

export type AccessPolicy = {
    projectFiles: AccessPolicyMode;
    dataSources: AccessPolicyMode;
    shellCommands: ShellAccessPolicy;
