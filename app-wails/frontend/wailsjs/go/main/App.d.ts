...
export function ApplyWorkspaceRollback(arg1:string):Promise<workspace.RollbackApplyResult>;
...
export function CancelConnectorProfileQuery(arg1:string):Promise<boolean>;
...
export function GetGitBlame(arg1:main.GitBlameRequest):Promise<main.GitBlameResult>;

export function GetGitFileDiff(arg1:string):Promise<main.GitFileDiff>;

export function GetGitHistory(arg1:main.GitHistoryRequest):Promise<main.GitHistoryResult>;
...
export function ListWorkspaceRollbacks():Promise<Array<workspace.RollbackRecord>>;
