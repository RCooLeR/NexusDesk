...
export function ApplyWorkspaceRollback(arg1) {
  return window['go']['main']['App']['ApplyWorkspaceRollback'](arg1);
}
...
export function ListWorkspaceRollbacks() {
  return window['go']['main']['App']['ListWorkspaceRollbacks']();
}
