...
export namespace dataset {
	...
	export class NotebookCell {
	    ...
	    static createFrom(source: any = {}) {
	        return new NotebookCell(source);
	    }
	...
	export class Notebook {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.relPath = source["relPath"];
	        this.label = source["label"];
	        this.cells = this.convertValues(source["cells"], NotebookCell);
	        this.updatedAt = source["updatedAt"];
	    }
	...
	export class NotebookSaveRequest {
	    id: string;
	    relPath: string;
	    label: string;
	    cells: NotebookCell[];
	    ...
	    static createFrom(source: any = {}) {
	        return new NotebookSaveRequest(source);
	    }
...
export namespace main {
	...
	export class GitBlameRequest {
	    path: string;
	    startLine: number;
	    endLine: number;

	    static createFrom(source: any = {}) {
	        return new GitBlameRequest(source);
	    }
	...
	export class GitBlameResult {
	    ...
	    static createFrom(source: any = {}) {
	        return new GitBlameResult(source);
	    }
	...
	export class GitHistoryEntry {
	    ...
	    static createFrom(source: any = {}) {
	        return new GitHistoryEntry(source);
	    }
	...
	export class GitHistoryRequest {
	    path: string;
	    limit: number;

	    static createFrom(source: any = {}) {
	        return new GitHistoryRequest(source);
	    }
	...
	export class GitHistoryResult {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.path = source["path"];
	        this.limit = source["limit"];
	        this.entries = this.convertValues(source["entries"], GitHistoryEntry);
	        this.truncated = source["truncated"];
	        this.message = source["message"];
	        this.generatedAt = source["generatedAt"];
	    }
...
export namespace workspace {
	...
	export class RollbackApplyResult {
	    id: string;
	    restored: string[];
	    removed: string[];
	    message: string;
	    ...
	    static createFrom(source: any = {}) {
	        return new RollbackApplyResult(source);
	    }
	...
	export class RollbackEntry {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.backupRelPath = source["backupRelPath"];
	        this.mode = source["mode"];
	        this.size = source["size"];
	        this.sha256 = source["sha256"];
	    }
