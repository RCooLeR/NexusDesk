...
2. Finish native editor/UI parity: syntax highlighting plan, minimap strategy, language actions, and less cramped native panels.
...
- [ ] IDE-grade editor baseline: syntax highlighting, broader formatting, minimap strategy, and language actions.
...
- [ ] Multi-tab editor polish with minimap, broader format coverage, and go-to-definition where available.
