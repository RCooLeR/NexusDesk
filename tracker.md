...
- Fix the remaining P0 Claude/Codex review items before broad new feature work: UI shell controller extraction and any follow-up search cancellation/debouncing needed in the shell controller layer.
