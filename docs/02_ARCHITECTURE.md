...
- `nexus-app/internal/services/tools/` owns deterministic tool descriptors, argument parsing, and dispatcher handlers for context, preview/search/problems, Git, tasks, approved terminal commands, rollbacks, approvals, safe mutations, artifacts, documents, operations, datasets, and SQLite.
