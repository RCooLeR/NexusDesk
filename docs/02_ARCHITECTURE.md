...
Preview data remains framework-free: `nexus-app/internal/services/workspace` classifies text, image, table, document, and binary previews and returns capped data, while `nexus-app/internal/ui/shell` chooses Fyne widgets for rendering.
