...
- Expand the SQLite connector with saved connector queries, richer schema navigation, table previews, relationship hints, and clearer read-only status. The first manual schema inspection path and explicit query guardrails are implemented.
