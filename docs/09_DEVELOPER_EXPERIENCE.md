...
- Expand the SQLite connector with query result exports, relationship hints, explain-schema actions, and clearer lineage. Manual schema inspection, explicit query guardrails, saved connector queries, schema-node previews, and query history are implemented.
