...
- Expand native Data & Analytics into the full SQL notebook shell, then add SQLite connector cancellation, saved connector queries, CSV/Markdown exports, query-history filters, and selected-object schema explanation.
