...
- `app/frontend/src/features/shell/ConnectorMetadataBrowser.tsx` owns connector schema navigation for inspected metadata. It can browse tables/views, column summaries, indexes, capped samples, and relationships for both workspace SQLite and saved external SQL profiles.
