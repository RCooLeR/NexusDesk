...
- Expand the native SQLite connector beyond schema inspection with guarded query preview, visible caps/timeouts, cancellation, saved connector queries, query history, CSV exports, Markdown report exports, connector query lineage, and selected-object schema explanation.
