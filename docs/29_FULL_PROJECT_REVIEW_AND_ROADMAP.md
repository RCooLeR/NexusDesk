...
1. Continue UI shell controller extraction with Data, Assistant, Artifacts, Diagnostics, and Editor controllers; the Search, Jobs, and Rollbacks controller slices are complete.
