...
1. Continue UI shell controller extraction with Data, Settings, and Editor controllers; the Search, Jobs, Rollbacks, Diagnostics, Git, Artifacts, and Assistant controller slices are complete.
