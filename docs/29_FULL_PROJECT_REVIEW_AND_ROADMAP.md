...
1. Continue UI shell controller extraction with Data, Assistant, Artifacts, Diagnostics, and Editor controllers; the Search and Jobs controller slices are complete.
