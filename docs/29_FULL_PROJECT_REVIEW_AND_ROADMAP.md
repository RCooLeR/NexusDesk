...
1. Continue UI shell controller extraction with Data, Assistant, Artifacts, Diagnostics, and Editor controllers; the first Search controller slice is complete.
