...
1. Continue UI shell controller extraction with Data, Assistant, Artifacts, and Editor controllers; the Search, Jobs, Rollbacks, Diagnostics, and Git controller slices are complete.
