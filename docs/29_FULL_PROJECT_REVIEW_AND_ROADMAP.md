...
1. Continue UI shell controller extraction with any remaining small shell clusters; the Search, Jobs, Rollbacks, Diagnostics, Git, Artifacts, Assistant, Editor, Data, Settings, and Operations controller slices are complete.
