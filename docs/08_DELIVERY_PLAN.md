...
Current estimate: Fyne-native migration is roughly 96-97% complete by useful Wails-era functionality, Wails useful-code parity is roughly 94-96%, Native Parity Beta readiness is roughly 90-93%, and overall production readiness is roughly 86%. Treat these as planning estimates, not release guarantees.
