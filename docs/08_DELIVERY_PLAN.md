...
Current estimate: Fyne-native migration is roughly 97% complete by useful Wails-era functionality, Wails useful-code parity is roughly 95-96%, Native Parity Beta readiness is roughly 92-94%, and overall production readiness is roughly 88%. Treat these as planning estimates, not release guarantees.
