...
5. Continue editor improvements: outline/symbol navigation, encoding controls, and format action hooks. Split editor groups, pinned tabs, breadcrumbs, and the Monaco minimap toggle are now implemented in the editor-quality foundation.
