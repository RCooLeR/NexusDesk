...
- editor quality: symbol search, go to definition where language services exist, diagnostics panel, problems panel, formatting, and file encoding controls. Split editor groups, tab pinning, breadcrumbs, outline navigation, and a minimap toggle exist in the current foundation.
