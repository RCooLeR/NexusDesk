...
3. Expand artifact regeneration beyond the current dataset summary/query/chart/notebook/SQLite/document-report/scan/document-extract/runbook/comparison/chat-answer refresh baseline as future generated artifact kinds, especially presentations, are added.
