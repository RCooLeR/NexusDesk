...
- IDE-grade editor baseline: syntax highlighting strategy, broader format coverage, minimap/language-action decisions, and continued outline/breadcrumb/split/find polish.
...
2. Continue editor parity: syntax highlighting decision, minimap strategy, and language-action behavior.
