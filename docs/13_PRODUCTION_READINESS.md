...
- IDE-grade editor baseline: syntax highlighting strategy, reliable find/replace, broader format coverage, minimap/language-action decisions, and continued outline/breadcrumb/split polish.
