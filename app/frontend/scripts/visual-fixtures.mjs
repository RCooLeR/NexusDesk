        ...
        window.go = {
            main: {
                App: {
                    ...
                    TestConnectorProfile: async () => ({profileId: 'postgres-smoke', name: 'Smoke warehouse', kind: 'postgres', engine: 'postgres-readonly', readOnly: true, message: 'PostgreSQL read-only connection succeeded for Smoke warehouse.'}),
                    InspectConnectorProfile: async () => ({
                        id: 'postgres:postgres-smoke',
                        relPath: 'postgres-smoke',
                        name: 'Smoke warehouse',
                        kind: 'postgres',
                        engine: 'postgres-readonly',
                        readOnly: true,
                        tables: [{name: 'public.campaigns', type: 'table', rowCount: 12, columns: [{name: 'id', type: 'integer', nullable: false, primaryKey: true, default: ''}, {name: 'account_id', type: 'integer', nullable: true, primaryKey: false, default: ''}], indexes: [], sampleRows: []}],
                        views: [],
                        indexes: [],
                        relationships: [{kind: 'inferred', fromTable: 'public.campaigns', fromColumn: 'account_id', toTable: 'public.accounts', toColumn: 'id', confidence: 'medium', reason: 'Column name follows a *_id pattern that matches another table.'}],
                        message: 'PostgreSQL connector metadata inspected: 1 tables, 0 views, 1 relationships.',
                    }),
                    ...
                    CreateSQLiteQueryCSVArtifact: async () => ({relPath: '.nexusdesk/artifacts/sqlite-query-smoke.csv', name: 'sqlite-query-smoke.csv', kind: 'sqlite-query-csv', size: 64, path: 'E:/smoke/NexusAugenticStudio/.nexusdesk/artifacts/sqlite-query-smoke.csv', message: 'CSV SQLite query artifact created inside the workspace with source citation.'}),
                    CreateSQLiteQueryMarkdownArtifact: async () => ({relPath: '.nexusdesk/artifacts/sqlite-query-smoke.md', name: 'sqlite-query-smoke.md', kind: 'sqlite-query-report', size: 128, path: 'E:/smoke/NexusAugenticStudio/.nexusdesk/artifacts/sqlite-query-smoke.md', message: 'Markdown SQLite query report created inside the workspace with SQL, guardrails, preview rows, and source citation.'}),
                    ...
                    InspectWorkspaceSQLite: async () => ({
                        ...
                        readOnly: true,
                        tables: [{name: 'campaigns', type: 'table', rowCount: 2, columns: [{name: 'id', type: 'INTEGER', nullable: false, primaryKey: true, default: ''}, {name: 'channel', type: 'TEXT', nullable: false, primaryKey: false, default: ''}, {name: 'account_id', type: 'INTEGER', nullable: true, primaryKey: false, default: ''}, {name: 'spend', type: 'INTEGER', nullable: true, primaryKey: false, default: ''}], indexes: [{name: 'campaigns_channel_idx', table: 'campaigns', unique: false, columns: ['channel']}], sampleRows: [['1', 'Search', '4', '120'], ['2', 'Email', '7', '40']]}],
                        views: [],
                        indexes: [{name: 'campaigns_channel_idx', table: 'campaigns', unique: false, columns: ['channel']}],
                        relationships: [{kind: 'inferred', fromTable: 'campaigns', fromColumn: 'account_id', toTable: 'accounts', toColumn: 'id', confidence: 'medium', reason: 'Column name follows a *_id pattern that matches another table.'}],
                        message: 'SQLite connector metadata inspected: 1 tables, 0 views, 1 relationships.',
                    }),
                },
            },
        };
