...
func TestWriteChatAnswerCreatesMarkdownAndMetadata(t *testing.T) {
	...
	text := string(data)
	for _, expected := range []string{"# Assistant Answer - Summarize README", "Model:** model-a", "README.md", "## Citations", "README.md:L12", "## Evidence", "Quality:** line-cited", "1 line ref", "## Prompt", "## Answer", "Use the setup guide."} {
